...
See [docs/GUIDE_ANE_FEATURE_SUPPORT_BY_GENERATION.md](../docs/GUIDE_ANE_FEATURE_SUPPORT_BY_GENERATION.md) for the curated table, the auto-generated extended table (106 setters), and the insights derived from it (generational feature waves, a genuine regression, permanently-dead API surface, and a known renaming caveat).
