...
| **0x000C** | 3 | `+0x204` | **InFmt_OutFmt** | **InFmt**: 0-1, **OutFmt**: 4-5. |
...
| **0x0024** | 9 | `+0x21c` | **Sync** | |
| **0x0028** | 10| `+0x220` | **ConvSxSyOxOy_REPLACED** | |
| **0x002C** | 11| `+0x224` | **ConvKhKw_REPLACED** | |
| **0x0030** | 12| `+0x228` | **ConvCfg3d_REPLACED** | |
