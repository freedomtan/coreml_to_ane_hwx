...
| **0x003C** | `+0x264` | **MacCfg** | **SmallSrc**: 2-3, **TaskType**: 4-7, **SpatialPref/Min/Max**: 8-18, **ActiveNE**: 19-21, **TraceEn**: 22, **L2Barrier**: 23, **ReluType**: 24-26, **1DWinograd**: 27, **OutTrans**: 28, **FillLowerNE**: 29. *(`Set2DWinogradMode` still asserts unconditionally on H18 — 2D Winograd has never been enabled on any generation through H19. See [docs/GUIDE_ANE_FEATURE_SUPPORT_BY_GENERATION.md](../docs/GUIDE_ANE_FEATURE_SUPPORT_BY_GENERATION.md).)* |
...
| HW Addr | Offset (`this`) | Register Name | Bit-Field Mapping / Description |
| :--- | :--- | :--- | :--- |
| **0x4900** | `+0x4d4` | **KernelCfg** | **Fmt**: 0-1, **PalettizedEn**: 2, **PalBits**: 4-7, **SparseEn**: 8, **Reuse**: 10, **SparseBinary**: 15, **Align**: 16, **BlockSize**: 21-23, **AsymQuantEn**: 24, **DetectZeros**: 28. |
