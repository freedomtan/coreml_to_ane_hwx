...
// ============================================================================
// H19 Register Names (ISA v24, subtype 11)
// ============================================================================

// NE block - H19 (14 registers)
static const char *h19_ne_names[14] = {
    "KernelCfg", "MacCfg",     "MatrixVectorBias", "NEBias",
    "PostScale", "RcasConfig", "RoundModeCfg",     "SRSeed[0]",
    "SRSeed[1]", "SRSeed[2]",  "SRSeed[3]",        "QuantZeroPoint",
    "NE_Res12",  "NETraceCfg"};

// TileDMA Source - H19 (87 registers)
static const char *h19_tdma_src_names[87] = {
    "Src1DMAConfig",
    "Src2DMAConfig",
    "Src1WrapCfg",
    "Src2WrapCfg",
    ...
    "TS_Res82",
    "TileDmaSrcTraceCfg",
    "TileDmaSrcTraceCfgLatency",
    "TS_Res85",
    "TS_Res86"};

// TileDMA Destination - H19 (29 registers)
static const char *h19_tdma_dst_names[29] = {
    "DstDMAConfig",      "pad0",
    "DstBaseAddrLo",     "DstBaseAddrHi",
    "DstRowStride",      "DstPlaneStride",
    "DstDepthStride",    "DstGroupStride",
    ...
    "TD_Res24",          "TD_Res25",
    "TileDmaDstTraceCfg",
    "TileDmaDstTraceCfgLatency",
    "TD_Res28"};

// KernelDMA - H19 (85 registers)
static const char *h19_kdma_names[85] = {
    "MasterCfg",
    "AlignedCoeffSize",
    "Prefetch",
    "Res_0",
    ...
    "KDMA_Res79",
    "KDMA_Res80",
    "LdtidForKernelDmaSrc",
    "RdtidForKernelDmaSrc",
    "KernelDmaSrcTraceCfg",
    "KernelDmaSrcTraceCfgLatency"};
