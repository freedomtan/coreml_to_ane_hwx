...
def parse_texture_setters(sym_file):
    symbols = {}
    with open(sym_file, 'r') as f:
        for line in f:
            ...
            if len(parts) >= 3:
                ...
                if "ZinAneTd<17u>::SetTexture" in func:
...
if __name__ == '__main__':
    parse_texture_setters('/Users/freedom/work/coreml_to_ane_hwx_hacks/hwx_dump/all_texture_setters.txt')
